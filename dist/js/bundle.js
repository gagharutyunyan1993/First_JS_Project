...
function modal() {
  ...
  more.addEventListener("click", function () {
    ...
    document.body.style.overflow = "hidden"; // otkluchit prakrutku
  });
...
function slider() {
  let slideIndex = 1, //parametr tekushevo slida
...
function tabs() {
  ...
  hideTabContent(1); // vse Tab-i krome pervovo
